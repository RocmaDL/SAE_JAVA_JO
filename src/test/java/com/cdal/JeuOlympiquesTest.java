...
public class JeuOlympiquesTest {
    ...
    public void setUp() {
        ...
        Epreuve epreuve1 = new Epreuve("50m", 9, 'M', sport1);
        Epreuve epreuve2 = new Epreuve("50m", 9, 'M', sport2);
        Epreuve epreuve3 = new Epreuve("50m", 9, 'M', sport3);
        Epreuve epreuve4 = new Epreuve("50m", 9, 'M', sport4);
        Epreuve epreuve5 = new Epreuve("50m", 9, 'M', sport5);
        Epreuve epreuve6 = new Epreuve("50m", 9, 'M', sport6);
