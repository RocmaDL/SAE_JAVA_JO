 ...
 * Les classes implémentant cette interface doivent fournir une implémentation de la méthode participer,
...
public interface Participer {
     ...
     * Cette méthode doit être implémentée par toute classe concrète désirant participer à une épreuve.
     * Le résultat de la participation est exprimé sous forme d'un double, pouvant représenter un score, un temps, etc.
     * 
